...
%moderate cc screw
%stable frequency, slightly increased frequency
screw_mod(1).hazard_fld         = 'intensity';
screw_mod(1).change             = 1.01;
...
%stable frequency, slightly increased frequency
%stable frequency, slightly increased frequency
screw_ext(1).hazard_fld         = 'intensity';
screw_ext(1).change             = 1.02;
