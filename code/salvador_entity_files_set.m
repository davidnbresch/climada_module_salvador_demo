    ...
    switch peril_ID
        ...
        case 'FL'
            if isempty(assets_file)
                assets_file = 'FL_entity_Acelhuate.xls';
        ...
        case 'TC'
            if isempty(assets_file)
                assets_file = 'TC_entity_AMSS.xls';
        ...
        case 'LS_las_canas'
            if isempty(assets_file)
               assets_file = 'LS_entity_las_canas.xls'; 
        ...
        case 'LS_acelhuate'
            if isempty(assets_file)
                assets_file = 'LS_entity_Acelhuate.xls';
